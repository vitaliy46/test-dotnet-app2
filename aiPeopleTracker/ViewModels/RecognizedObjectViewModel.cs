...
{
    public class RecognizedObjectViewModel : ViewModelBase
    {
        ...
        public Point LeftBottomPoint
        {
            ...
            set
            {
                SetField(ref _leftBottomPoint, value);
            }
        }
        ...
        public Point RightTopPoint
        {
            ...
            set
            {
                SetField(ref _rightTopPoint, value);
            }
        }

        public RecognizedObjectViewModel()
        {
        ...
        /// </summary>
        public void FillPlayersContexts(MultitimelineObjectControl multitimelineObjectControl, NotifyCollectionChangedEventArgs e)
        {
            var playableVideoClips = multitimelineObjectControl.Multitimeline.PlayableVideoClips;

            var position = multitimelineObjectControl.SliderValue - multitimelineObjectControl.LeftDate;
        ...
        public void TrackerPositionChangeOnPaused(MultitimelineObjectControl multitimelinePersonControl)
        {
